          ...
          <section className="mt-16 text-left space-y-16">
            <div>
                ...
                <div className="mt-6 space-y-6 text-foreground/80">
                    <p>En InstaVector, hemos simplificado el complejo proceso de vectorización en una experiencia intuitiva y accesible para todos. Nuestra plataforma está diseñada para que puedas obtener gráficos vectoriales de alta calidad sin necesidad de conocimientos técnicos avanzados ni software costoso. El flujo de trabajo se reduce a tres pasos fundamentales:</p>
            ...
            <div>
              ...
              <p className="mt-2 text-xl text-muted-foreground text-center">
                  Desde iconos simples hasta ilustraciones complejas, nuestro motor de IA se adapta para ofrecer la mejor calidad.
              </p>
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-foreground/80">
                  ...
                  <li className="flex items-start gap-3">
                      <Users className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
                      <div>
                          <strong className="font-semibold text-foreground">Desarrolladores web y marketers:</strong> Optimiza el rendimiento de tu sitio web utilizando gráficos SVG ligeros que se cargan al instante y se ven perfectos en cualquier dispositivo, mejorando los Core Web Vitals y el SEO. Crea banners y assets para campañas digitales que no se pixelen, garantizando una imagen profesional.
                      </div>
                  </li>
                  <li className="flex items-start gap-3">
                      <Users className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
                      <div>
                          <strong className="font-semibold text-foreground">Profesionales de impresión y merchandising:</strong> Prepara tus diseños para producción física en segundos. Los archivos SVG son perfectos para máquinas de corte por plotter, serigrafía, impresión de camisetas, creación de folletos y cualquier material publicitario que exija la máxima resolución.
                      </div>
                  </li>
                   <li className="flex items-start gap-3">
                      <Users className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
                      <div>
                          <strong className="font-semibold text-foreground">Educadores y estudiantes de diseño:</strong> InstaVector es una herramienta educativa excelente para entender los fundamentos de los gráficos vectoriales. Permite a los estudiantes practicar la vectorización de forma rápida y gratuita, y a los educadores demostrar la diferencia clave entre formatos raster y vectorial de manera interactiva.
                      </div>
                  </li>
              </ul>
