                ...
                <div className="mt-6 space-y-6 text-foreground/80">
                    ...
                    <ol className="space-y-4">
                        <li className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-foreground text-lg">Sube tu imagen</h3>
                        ...
                        <li className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-foreground text-lg">Vectorización automática e inteligente</h3>
                        ...
                        <li className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-foreground text-lg">Descarga tu vector SVG</h3>
